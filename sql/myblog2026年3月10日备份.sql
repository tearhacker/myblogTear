...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '恋爱签到表(隐形)' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '一念签到表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'APP用户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_user
-- ----------------------------
INSERT INTO `app_user` VALUES (1, '523341786', '蕴宇', NULL, NULL, NULL, '2026-03-08 16:52:30', '2026-03-09 20:43:41', '2026-03-09 20:43:41', 1);
INSERT INTO `app_user` VALUES (2, '2254013571', '泪心', NULL, NULL, NULL, '2026-03-08 17:14:23', '2026-03-09 19:38:25', '2026-03-09 19:38:25', 1);
...
CREATE TABLE `app_user_stats`  (
  ...
  INDEX `idx_qq_number`(`qq_number` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户签到统计表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_user_stats
-- ----------------------------
INSERT INTO `app_user_stats` VALUES (1, 1, '523341786', 2, 2, 3, '2026-03-10', 2, 2, '2026-03-10 09:43:22');
INSERT INTO `app_user_stats` VALUES (2, 2, '2254013571', 0, 0, 0, NULL, 1, 1, '2026-03-09 19:38:45');
...
-- ----------------------------
INSERT INTO `app_version` VALUES (1, 1, '1.0', '1. 一念APP首发上线\n2. 支持QQ号登录\n3. 支持每日签到功能\n4. 支持恋爱签到(隐藏功能)', 'https://www.123865.com/s/Tjzdjv-ryyCA', 0, 1, '2026-03-07 20:52:01', '2026-03-07 21:27:40');
...
-- ----------------------------
INSERT INTO `t_api_secret` VALUES (2, 'GPointerNPoIDEALKinger', 0, '一念灰烬', '4.0', NULL, 23843, 143, '2026-03-10', '2026-03-10 09:44:14', '泪心2026无痕驱动免费对接版本', '2026-01-05 08:48:37', '2026-03-10 09:44:14');
INSERT INTO `t_api_secret` VALUES (3, 'TEAR-54208BCA-289F-44', 0, '永恒泪心', '4.0', NULL, 13650, 9, '2026-03-10', '2026-03-10 09:38:23', '泪心作者本人专用驱动调用密钥', '2026-01-05 18:01:30', '2026-03-10 09:38:23');
INSERT INTO `t_api_secret` VALUES (4, 'TEARGAME-UPXFD192-2026', 0, '泪心加密UPX新年版', '6.0.0', NULL, 224, 1, '2026-03-10', '2026-03-10 00:07:35', '泪心2026年1月13日开发UPX加壳项目', '2026-01-13 08:51:16', '2026-03-10 00:07:35');
