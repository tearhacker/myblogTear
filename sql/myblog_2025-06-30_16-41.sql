...
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_comment` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2194 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_comment` VALUES (2193,'泪心','2254013571@qq.com','部分功能可能无效，这是预算问题，没有额外资金支持子功能如邮箱服务或redis缓存支持等等。','/images/avatar.png','2025-06-29 05:43:39',94,-1,_binary '\0');
...
CREATE TABLE `t_message` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8133 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_message` VALUES (8132,'泪心','2254013571@qq.com','曾深深痴迷不愿睡醒的梦,怎就突然一朝醒来了？','/images/avatar.png','2025-06-29 05:45:12',-1,_binary '\0',NULL);
...
CREATE TABLE `t_resources` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=473 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_type` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_type` VALUES (43,'泪心叙事、人生圆缺'),(44,'泪心技术、经验分享');
...
INSERT INTO `t_user` VALUES (3,'/images/avatar.png','2025-06-27 21:36:00','2254013571@qq.com','tear','e10adc3949ba59abbe56e057f20f883e',0,'2025-06-27 21:36:17','123456');
...
-- Dump completed on 2025-06-30 16:41:27
