...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '恋爱签到表(隐形)' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '一念签到表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'APP用户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_user
-- ----------------------------
INSERT INTO `app_user` VALUES (1, '523341786', '蕴宇', NULL, NULL, NULL, '2026-03-08 16:52:30', '2026-03-08 16:52:30', NULL, 1);
INSERT INTO `app_user` VALUES (2, '2254013571', '泪心', NULL, NULL, NULL, '2026-03-08 17:14:23', '2026-03-08 17:14:23', NULL, 1);
...
CREATE TABLE `app_user_stats`  (
  ...
  INDEX `idx_qq_number`(`qq_number` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户签到统计表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_user_stats
-- ----------------------------
INSERT INTO `app_user_stats` VALUES (1, 1, '523341786', 0, 0, 0, NULL, 1, 1, '2026-03-08 16:53:02');
INSERT INTO `app_user_stats` VALUES (2, 2, '2254013571', 0, 0, 0, NULL, 0, 0, '2026-03-08 17:14:23');
...
-- ----------------------------
INSERT INTO `t_api_secret` VALUES (2, 'GPointerNPoIDEALKinger', 0, '一念灰烬', '4.0', NULL, 22987, 707, '2026-03-08', '2026-03-08 21:58:22', '泪心2026无痕驱动免费对接版本', '2026-01-05 08:48:37', '2026-03-08 21:58:22');
INSERT INTO `t_api_secret` VALUES (3, 'TEAR-54208BCA-289F-44', 0, '永恒泪心', '4.0', NULL, 13569, 51, '2026-03-08', '2026-03-08 21:19:28', '泪心作者本人专用驱动调用密钥', '2026-01-05 18:01:30', '2026-03-08 21:19:28');
INSERT INTO `t_api_secret` VALUES (4, 'TEARGAME-UPXFD192-2026', 0, '泪心加密UPX新年版', '6.0.0', NULL, 220, 3, '2026-03-08', '2026-03-08 20:29:30', '泪心2026年1月13日开发UPX加壳项目', '2026-01-13 08:51:16', '2026-03-08 20:29:30');
