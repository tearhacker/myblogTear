...
CREATE TABLE `app_ai_config`  (
  ...
  `is_enabled` tinyint NULL DEFAULT 0 COMMENT '是否启用 0禁用 1启用',
...
-- ----------------------------
INSERT INTO `app_ai_config` VALUES (1, 'DouYin-Tear-20260225113455', 'https://ark.cn-beijing.volces.com/api/v3/chat/completions', 'afb70791-a966-48d6-a671-d0bf87674d2f', 'doubao-seed-2-0-pro-260215', '请为一位坚持签到{days}天的用户生成一句温暖治愈的签到寄语，要求简短有深意，不超过50字。', 1, '2026-03-07 18:24:00', '2026-03-08 12:29:24');

-- ----------------------------
-- Table structure for app_discussion
-- ----------------------------
DROP TABLE IF EXISTS `app_discussion`;
CREATE TABLE `app_discussion`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  ...
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '话题标题',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '话题内容',
  ...
  INDEX `idx_qq_number`(`qq_number` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'APP话题讨论表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_discussion
-- ----------------------------
INSERT INTO `app_discussion` VALUES (3, 1, '523341786', '蕴宇', 'null', '开发者寄语', '这个软件APP并不是为了即时恋爱表白，它的核心，是让你做回自己，不再随波逐流，不再被生活所伤；是让你追寻梦想，不再被环境打压欺恨。\n \n它也为你保留了一份温柔：去勇敢追求那个曾藏在你心底的人吧——直到你确认自己拥有了对应的能力与担当，再去奔赴这场重逢。你或许会问，一切是否还来得及？那个人是否早已变迁？\n \n开发者九死一生，经历过太多太多苦恼。愿我所有的困难化作繁星点点，为每一个人的幸福安康渡劫，也为每一段迟来却真诚的爱意，照亮前路。', 1, 8, 0, 2, '2026-03-11 08:28:38', '2026-03-11 23:47:24', '2026-03-11 08:44:01', 3, NULL);

-- ----------------------------
-- Table structure for app_discussion_comment
-- ----------------------------
DROP TABLE IF EXISTS `app_discussion_comment`;
CREATE TABLE `app_discussion_comment`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'APP话题评论表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_discussion_comment
-- ----------------------------
...
CREATE TABLE `app_love_signin`  (
  ...
  `signin_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '签到时间',
  `continuous_days` int NULL DEFAULT 1 COMMENT '连续签到天数',
  `total_days` int NULL DEFAULT NULL COMMENT '累计签到天数',
  `love_message` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '恋爱寄语(AI生成)',
  `love_level` int NULL DEFAULT 1 COMMENT '恋爱等级 1-10',
  `ai_generated` tinyint NULL DEFAULT 0 COMMENT '是否AI生成寄语',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_date`(`user_id` ASC, `signin_date` ASC) USING BTREE,
  INDEX `idx_qq_number`(`qq_number` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '恋爱签到表(隐形)' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_love_signin
-- ----------------------------
INSERT INTO `app_love_signin` VALUES (1, 1, '523341786', '欧阳颖', '2026-03-07', '2026-03-08 08:53:03', 1, 1, '时光荏苒，唯有这份心意，始终如一。', 1, 0);
INSERT INTO `app_love_signin` VALUES (2, 1, '523341786', '欧阳颖', '2026-03-08', '2026-03-09 00:45:58', 1, 2, '初中时的悸动，至今仍在心间。愿时光温柔以待。', 1, 0);
INSERT INTO `app_love_signin` VALUES (3, 3, '1234567890', '欧阳颖', '2026-03-08', '2026-03-09 09:39:38', 1, 1, '欧阳颖，这个名字，是我青春最美的秘密。', 1, 0);
INSERT INTO `app_love_signin` VALUES (10, 1, '523341786', '欧阳颖', '2026-03-10', '2026-03-10 20:55:53', 1, 3, '欧阳颖，这个名字，是我青春最美的秘密。', 1, 0);
INSERT INTO `app_love_signin` VALUES (19, 1, '523341786', '欧阳颖', '2026-03-11', '2026-03-11 00:24:44', 2, 4, '四天攒下的细碎思念都藏在签到里，连满两天的惦念全关于欧阳颖，南风知我意，慢慢来，你的心意终会传到她耳边。', 1, 1);
INSERT INTO `app_love_signin` VALUES (22, 12, '2254013571', '泪心', '2026-03-11', '2026-03-11 11:44:12', 1, 1, '今天是为泪心签到的第一天，情不知所起一往而深，每一笔记录都是藏在心底的软，慢慢来，细碎的思念终会凑成圆满。', 1, 1);
INSERT INTO `app_love_signin` VALUES (23, 13, '3462150976', '666', '2026-03-11', '2026-03-11 20:17:02', 1, 1, '第一天的签到是思念的序章，把细碎的心动悄悄攒着，慢慢来，这份藏在心底的温柔总会被666稳稳接住的。', 1, 1);
INSERT INTO `app_love_signin` VALUES (24, 1, '523341786', 'Ta', '2026-03-12', '2026-03-12 08:56:30', 3, 5, '连续第三天的惦念软得像春云，累计五次的心意正悄悄抽芽，南风知我意，总有天会把你的回应吹到我身边。', 1, 1);
...
CREATE TABLE `app_signin`  (
  ...
  `mood` tinyint NULL DEFAULT 0 COMMENT '心情 0平静 1开心 2难过 3焦虑',
  `ai_generated` tinyint NULL DEFAULT 0 COMMENT '是否AI生成寄语 0否 1是',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_date`(`user_id` ASC, `signin_date` ASC) USING BTREE,
  INDEX `idx_qq_number`(`qq_number` ASC) USING BTREE,
  INDEX `idx_signin_date`(`signin_date` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '一念签到表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_signin
-- ----------------------------
INSERT INTO `app_signin` VALUES (1, 3, '1234567890', '2026-03-08', '2026-03-09 01:56:39', 1, 1, '人生路漫漫，愿你落子无悔，所愿皆所得。', NULL, 0);
INSERT INTO `app_signin` VALUES (2, 1, '523341786', '2026-03-08', '2026-03-09 05:02:20', 1, 1, '每一次签到，都是与自己的约定。坚持，就是力量。', NULL, 0);
INSERT INTO `app_signin` VALUES (4, 1, '523341786', '2026-03-09', '2026-03-10 01:43:23', 1, 2, '心若向阳，无惧悲伤。愿你今日温暖如初。', NULL, 0);
INSERT INTO `app_signin` VALUES (5, 1, '523341786', '2026-03-10', '2026-03-10 11:27:05', 2, 3, '从泪心到本心，你正在书写自己的故事。', NULL, 0);
INSERT INTO `app_signin` VALUES (23, 1, '523341786', '2026-03-11', '2026-03-11 00:24:01', 3, 4, '你已连续签到3天、累计签到4天啦，一念守本心莫随波逐流，哪怕遇逆境也别慌，山重水复后自有柳暗花明，你正朝着初心慢慢靠近。', NULL, 1);
INSERT INTO `app_signin` VALUES (26, 12, '2254013571', '2026-03-11', '2026-03-11 11:45:41', 1, 1, '恭喜你完成「一念」首日签到，从今天起锚定本心不随波逐流，山重水复后自有柳暗花明，你想要的答案一直都在你身上。', NULL, 1);
INSERT INTO `app_signin` VALUES (27, 13, '3462150976', '2026-03-11', '2026-03-11 20:13:26', 1, 1, '恭喜你解锁「一念」的第一次签到，今天起试着不随波逐流，守好初心，哪怕遇逆境，也终能走到柳暗花明的自在处。', NULL, 1);
INSERT INTO `app_signin` VALUES (28, 1, '523341786', '2026-03-12', '2026-03-12 08:54:45', 4, 5, '你已在一念连续签到4天、累计签到5天啦，不必盲从旁人的脚步，顺着本心走，熬过沉潜的日子，自有柳暗花明的惊喜。', NULL, 1);
...
CREATE TABLE `app_signin_message`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `message_type` tinyint NULL DEFAULT 1 COMMENT '类型 1一念签到 2恋爱签到',
  `message_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '寄语内容',
  `mood_type` tinyint NULL DEFAULT 0 COMMENT '适用心情',
...
CREATE TABLE `app_user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_qq_number`(`qq_number` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'APP用户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_user
-- ----------------------------
INSERT INTO `app_user` VALUES (1, '523341786', '蕴宇', NULL, NULL, NULL, '2026-03-08 16:52:30', '2026-03-11 23:46:38', '2026-03-11 23:46:38', 1);
INSERT INTO `app_user` VALUES (3, '1234567890', '.', NULL, NULL, NULL, '2026-03-09 09:56:33', '2026-03-09 17:33:57', '2026-03-09 17:33:57', 1);
INSERT INTO `app_user` VALUES (12, '2254013571', '泪心', NULL, NULL, NULL, '2026-03-11 11:36:31', '2026-03-11 11:36:31', NULL, 1);
INSERT INTO `app_user` VALUES (13, '3462150976', '测试', NULL, NULL, NULL, '2026-03-11 20:12:58', '2026-03-11 20:16:00', '2026-03-11 20:16:00', 1);
...
CREATE TABLE `app_user_stats`  (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `qq_number` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'QQ号',
  `total_signin_days` int NULL DEFAULT 0 COMMENT '累计签到天数',
  `continuous_signin_days` int NULL DEFAULT 0 COMMENT '连续签到天数',
  `max_continuous_days` int NULL DEFAULT 0 COMMENT '最大连续天数',
  `last_signin_date` date NULL DEFAULT NULL COMMENT '最后签到日期',
  `love_signin_days` int NULL DEFAULT 0 COMMENT '恋爱签到天数',
  `love_continuous_days` int NULL DEFAULT 0 COMMENT '恋爱连续天数',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_qq_number`(`qq_number` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户签到统计表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_user_stats
-- ----------------------------
INSERT INTO `app_user_stats` VALUES (1, 1, '523341786', 5, 5, 6, '2026-03-12', 5, 5, '2026-03-12 08:56:29');
INSERT INTO `app_user_stats` VALUES (3, 3, '1234567890', 1, 1, 2, '2026-03-09', 1, 1, '2026-03-09 17:39:38');
INSERT INTO `app_user_stats` VALUES (12, 12, '2254013571', 1, 1, 2, '2026-03-11', 1, 1, '2026-03-11 11:45:40');
INSERT INTO `app_user_stats` VALUES (13, 13, '3462150976', 1, 1, 2, '2026-03-11', 1, 1, '2026-03-11 20:17:01');
...
CREATE TABLE `app_version`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `version_code` int NOT NULL COMMENT '版本号(数字，如100)',
  `version_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '版本名称(如1.0.0)',
  ...
  `force_update` tinyint NULL DEFAULT 0 COMMENT '是否强制更新 0否 1是',
  `is_latest` tinyint NULL DEFAULT 1 COMMENT '是否最新版本 0否 1是',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_version_code`(`version_code` ASC) USING BTREE,
  INDEX `idx_is_latest`(`is_latest` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'APP版本管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of app_version
-- ----------------------------
INSERT INTO `app_version` VALUES (1, 3, '1.3', '1.移除用户中心AI助手菜单项及AI智能功能章节。\r\n2.新增话题讨论社区、恋爱小游戏模块（爱心消消乐、记忆翻牌、情话接龙）、关于和赞赏页面。\r\n3.到寄语由豆包AI深度思考智能生成，根据签到天数匹配主题风格,响应回复寄语。\r\n4.优化表白系统设计,让思念和爱意具象化。', 'https://www.123865.com/s/Tjzdjv-ryyCA', 0, 1, '2026-03-07 20:52:01', '2026-03-11 08:15:40');
...
CREATE TABLE `t_api_secret`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_tear_secret`(`tear_secret` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
...
-- ----------------------------
INSERT INTO `t_api_secret` VALUES (2, 'GPointerNPoIDEALKinger', 0, '一念灰烬', '4.0', NULL, 25164, 286, '2026-03-12', '2026-03-12 14:17:44', '泪心2026无痕驱动免费对接版本', '2026-01-05 08:48:37', '2026-03-12 14:17:44');
INSERT INTO `t_api_secret` VALUES (3, 'TEAR-54208BCA-289F-44', 0, '永恒泪心', '4.0', NULL, 13781, 16, '2026-03-12', '2026-03-12 13:42:59', '泪心作者本人专用驱动调用密钥', '2026-01-05 18:01:30', '2026-03-12 13:42:59');
INSERT INTO `t_api_secret` VALUES (4, 'TEARGAME-UPXFD192-2026', 0, '泪心加密UPX新年版', '6.0.0', NULL, 230, 4, '2026-03-11', '2026-03-11 20:03:53', '泪心2026年1月13日开发UPX加壳项目', '2026-01-13 08:51:16', '2026-03-11 20:03:53');
...
CREATE TABLE `t_blog`  (
  ...
  `first_picture_upload_id` bigint NULL DEFAULT NULL COMMENT '首图上传文件ID',
  ...
  `blog_status` int NOT NULL DEFAULT 1 COMMENT '博文状态：1-普通公开，2-机密，3-绝密',
...
CREATE TABLE `t_comment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2196 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_comment` VALUES (2194, '蕴宇', NULL, '我觉得非常不对啊', 'null', '2026-03-08 03:59:22', 93, NULL, b'0');
INSERT INTO `t_comment` VALUES (2195, '蕴宇', NULL, '1', 'null', '2026-03-08 04:07:07', 93, NULL, b'0');
...
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '文件上传表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_file_upload` VALUES (24, '刻晴.jpg', '72d2c1b5777c4a299b6801a244c1710a_1771081567643.jpg', 'C:\\Users\\Administrator\\AppData\\Local\\Temp\\1\\tomcat.9252016329083138837.80\\webapps\\uploads\\2026\\02\\14\\72d2c1b5777c4a299b6801a244c1710a_1771081567643.jpg', '/api/files/download/24', 1605126, 'image/jpeg', 'jpg', '2026-02-14 15:06:08', '117.169.196.21', '博客首图', 22924, 0);
INSERT INTO `t_file_upload` VALUES (25, 'sen.jpg', 'ed3f569f1c5348d8843e499a884be430_1772939421968.jpg', 'C:\\Users\\Administrator\\AppData\\Local\\Temp\\1\\tomcat.9274839349337356061.80\\webapps\\uploads\\2026\\03\\08\\ed3f569f1c5348d8843e499a884be430_1772939421968.jpg', '/api/files/download/25', 270311, 'image/jpeg', 'jpg', '2026-03-08 03:10:22', '113.87.38.112', '博客首图', 1, 1);
INSERT INTO `t_file_upload` VALUES (26, 'anniBG.jpg', 'bb2f531996e14c31a089109a7dc3737e_1772939578287.jpg', 'C:\\Users\\Administrator\\AppData\\Local\\Temp\\1\\tomcat.9274839349337356061.80\\webapps\\uploads\\2026\\03\\08\\bb2f531996e14c31a089109a7dc3737e_1772939578287.jpg', '/api/files/download/26', 1131903, 'image/jpeg', 'jpg', '2026-03-08 03:12:58', '113.87.38.112', '博客首图', 1505, 0);
